...
public class WarningPanes {
    ...
    public static void main ( String[] args ) {
        ...
        JOptionPane.showMessageDialog( null, "Please select a User", null, JOptionPane.WARNING_MESSAGE, null );
        JOptionPane.showConfirmDialog( null, "Are you sure you want to clear all fields?", null, JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE );
        JOptionPane.showConfirmDialog( null, "Are you sure you want to add to the database", null, JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE );
    }
