...
class ModuleView extends View {
  private static final long serialVersionUID = -6445280482886189347L;
  ...
  ModuleView() {
    ...
    this.typeOptions = new JComboBox<>(new DefaultComboBoxModel<String>(new String[] {"Full Time",
        "Part Time"}));
    constraints.gridx = 1;
    constraints.gridy = 0;
    ...
    this.createNew.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(final ActionEvent actionEvent) {
        ...
        final JFrame newPanel = ModuleView.this.getCreateNewPanel();
