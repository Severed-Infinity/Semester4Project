	...
	public TimetableView() throws HeadlessException {
		...
		addNewCourse
				.setBorder(new TitledBorder(UIManager
						.getBorder("TitledBorder.border"), "Add New Course",
		...
		addNewModule
				.setBorder(new TitledBorder(UIManager
						.getBorder("TitledBorder.border"), "Add New Module",
						TitledBorder.CENTER, TitledBorder.TOP, null, new Color(
								0, 0, 0)));
		...
		userSelect.setModel(new DefaultComboBoxModel<String>(new String[] {
