...
@SuppressWarnings ("serial") public class TimetableView extends JFrame {
    ...
    public TimetableView () throws HeadlessException {
        ...
        gl_header.setHorizontalGroup(gl_header.createParallelGroup(Alignment.LEADING).addGroup(
                gl_header
                        ...
                        .addGap(78)
                        .addComponent(txtSearch, GroupLayout.PREFERRED_SIZE, 313,
                                GroupLayout.PREFERRED_SIZE).addGap(18)
                        .addComponent(lblUser, GroupLayout.DEFAULT_SIZE, 231, Short.MAX_VALUE)
                        .addContainerGap()));
        gl_header.setVerticalGroup(gl_header.createParallelGroup(Alignment.LEADING).addGroup(
                gl_header
                        .createSequentialGroup()
                        .addContainerGap()
                        .addGroup(
                                gl_header
                                        ...
                                        .addComponent(txtSearch, GroupLayout.PREFERRED_SIZE, 23,
                                                GroupLayout.PREFERRED_SIZE)
                                        .addComponent(btnLogout)
                                        .addComponent(btnHome)
                                        .addComponent(lblUser, GroupLayout.PREFERRED_SIZE, 23,
                                                GroupLayout.PREFERRED_SIZE))));
        ...
        addNewCourse.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
        ...
        comboBox_3.setModel(new DefaultComboBoxModel<String>(new String[] { "Full time",
                "Part time" }));
        ...
        comboBox_4.setModel(new DefaultComboBoxModel<String>(new String[] {
                "School of Science and Computing", "School of Business & Humanities",
        ...
        addUserView.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"),
        ...
        userSelect.setModel(new DefaultComboBoxModel<String>(new String[] { "Admin", "Lecturer",
                "Student" }));
